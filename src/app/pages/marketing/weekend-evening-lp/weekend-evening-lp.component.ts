...
@Component({
  selector: 'app-weekend-evening-lp',
  templateUrl: './weekend-evening-lp.component.html',
  styleUrls: ['./weekend-evening-lp.component.scss']
})
export class WeekendEveningLpComponent implements OnInit {
...
ngOnInit(): void {
  ...
  this.titleService.setTitle('Weekend UPSC Coaching - Flexible Learning in India - VerandaIAS program');

  // Set the meta tags for the page
  this.metaService.addTags([
    { name: 'keywords', content: 'weekend batch for upsc, upsc weekend classes, weekend classes for upsc, weekend coaching for upsc, weekend upsc online classes, weekend online classes for upsc, weekend online coaching for upsc, best weekend batch for upsc online, upsc preparation on weekends online, part-time upsc coaching online, flexible upsc study program online, upsc classes for working professionals online' },
    { name: 'description', content: 'Join our weekend batch for UPSC coaching in India. Flexible schedules and expert guidance tailored for working professionals. Sign up today.' },
  ]);
}
...
onStateChange(selectedState: string): void {
  ...
  faqs = [
    ...
    {
      question: 'Are mentorship sessions available for the UPSC CSAT classes?',
      answer: 'Yes, we provide free mentorship sessions for all subjects, including the UPSC CSAT paper. Additionally, you can clarify your doubts during live classes to prepare successfully for the UPSC CSE 2025.',
      imageUrl: '././assets/Coursepage/faq/faq-3.JPG'
    },
    {
      question: 'Is the UPSC mock test/test series for UPSC included in Veranda IAS’s UPSC CSE evening & weekend online classes?',
      answer: 'Yes, Veranda IAS’s UPSC CSE evening & weekend online classes include UPSC mock test and free prelims & mains test series for UPSC.',
    ...
    },
    {
      ...
      answer: 'Upon successful enrollment in our Veranda IAS coaching for UPSC Preparation for 2025, you will receive benefits including 500+ hours of classes, 30 hours of free mentorship sessions, complete UPSC CSAT classes, free monthly current affairs classes, UPSC Prelims study materials, UPSC Prelims mock test, UPSC Prelims strategy for 2025, test series for UPSC and more.',
      imageUrl: '././assets/Coursepage/faq/faq-4.JPG'
    },
  ]; 
