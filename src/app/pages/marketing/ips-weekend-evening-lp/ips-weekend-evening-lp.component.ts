...
@Component({
  selector: 'app-ips-weekend-evening-lp',
  templateUrl: './ips-weekend-evening-lp.component.html',
  styleUrls: ['./ips-weekend-evening-lp.component.scss']
})

export class IpsWeekendEveningLpComponent implements OnInit {
...
ngOnInit(): void {
  ...
  this.metaService.addTags([
    { name: 'keywords', content: 'IPS Online Coaching, IPS Coaching Institute, IPS Coaching Academy, IPS Coaching Centre, IPS Coaching Classes' },
    { name: 'description', content: 'Join our IPS Online Coaching - Evening & Weekend batch for comprehensive guidance from experienced faculty, live classes, study materials, current affairs classes and test series. Prepare effectively from the comfort of your home and achieve your dream of becoming an IPS officer. Enroll now for expert mentoring and success strategies!' },
  ]);
}
...
onStateChange(selectedState: string): void {
  ...
  faqs = [
    {
      question: 'Does this IPS coaching academy provide live classes?',
      answer: 'Yes, we will provide you with recorded videos of all live classes. In case if a student misses a live class he/she can watch the recorded video of the same.'
    },
        {
    ...
    {
      question: 'Does this IPS Coaching Academy provide mentorship sessions for CSAT classes?',
      answer: 'Yes, we provide free mentorship sessions for all subjects, including the CSAT paper. Additionally, you can clarify your doubts during live classes to prepare successfully for the upcoming UPSC IPS Exam 2025.'
    },
    {
      question: 'Is UPSC mock test/test series for UPSC included in Veranda IAS’s UPSC IPS Exam evening & weekend online classes?',
      answer: 'Yes, Veranda IAS’s UPSC IPS Exam evening & weekend online classes include UPSC mock test and free prelims & mains test series for UPSC.'
    },
    {
      question: 'Can we avail evening & weekend online classes for IPS Mains Exam coaching?',
    ...
    {
      question: 'Apart from online classes, what benefits can we gain from Veranda IAS coaching for UPSC Prelims 2025?',
      answer: 'Upon successful enrollment in our Veranda IAS for IPS online classes, you will receive benefits including 500+ hours of classes, 30 hours of free mentorship sessions, complete UPSC CSAT classes, free monthly current affairs classes, UPSC Prelims study materials, UPSC Prelims mock test, UPSC Prelims strategy for 2025, test series for UPSC and more.'
    },
    {
      question: 'Will students get current affairs sessions?',
      answer: 'Yes, separate current affairs sessions will be provided for the students at regular intervals.',
    },
  ]; 
